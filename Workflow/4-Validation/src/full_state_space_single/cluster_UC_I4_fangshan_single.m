function [output_matrix, output_obj, output_status] = cluster_UC_I4_fangshan_single(topology, Ptot_command, fault, fault_command, solver_options)
...
type=topology;
cluster_parameters_fangshan_single;
