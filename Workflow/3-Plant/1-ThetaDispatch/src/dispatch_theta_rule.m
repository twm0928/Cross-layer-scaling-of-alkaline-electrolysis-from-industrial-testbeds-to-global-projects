...
% Original theta/base dispatch rule.
%
% If cfg.n_modules is provided, the plant capacity is fixed and excess
% renewable power is curtailed. This keeps the benchmark aligned with the
% original plant case instead of changing the number of modules by scenario.
