...
%LOAD_MODULE_PH_MAP Load module P-H2 maps from constant-profile simulations.
%
% Output maps(t) contains breakpoints for topology t:
%   power_MW        module input power breakpoints
%   hydrogen_tph    hydrogen production in tonne H2 per hour
%   efficiency      LHV efficiency on command-power basis
