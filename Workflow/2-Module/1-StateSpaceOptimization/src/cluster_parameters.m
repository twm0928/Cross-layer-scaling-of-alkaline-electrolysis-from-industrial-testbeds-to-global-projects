...
a0 = ((un+(r1+r2*60)*8000)-(un+(r1+r2*60)*6000))/2000; % （单位：V/A）
a1 = ((un+(r1+r2*50)*7000)-(un+(r1+r2*30)*7000))/20; % （单位：V/℃）
a2 = (un+(r1+r2*30)*7000) - a0*7000 - a1*30; % （单位：V）
...
dT=20; % 温度取值间隔
dI=2000; % 电流取值间隔，这里跟4位2进制电流分段无关，分段只限制杂质约束
for T=10:dT:70
